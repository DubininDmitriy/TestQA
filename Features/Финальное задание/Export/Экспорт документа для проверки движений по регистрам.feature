...
Сценарий: подготовка документа для проверки "СсылкаНаДокумент"
	И я закрываю все окна клиентского приложения
//	И Я запоминаю значение выражения '"e1cib/data/Документ.РасходТовара?ref=" + СтрЗаменить(Новый УникальныйИдентификатор(), "-", "")' в переменную "СсылкаНаДокумент"
